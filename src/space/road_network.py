...
class CampusWalkway(RoadNetwork):
    campus: str
    _path_select_cache: Dict[Tuple[FloatCoordinate, FloatCoordinate], List[FloatCoordinate]]
    ...
    def get_cached_path(self, source: FloatCoordinate, target: FloatCoordinate) -> Optional[List[FloatCoordinate]]:
